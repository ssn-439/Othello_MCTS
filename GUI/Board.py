...
class Board:
                ...
                if self.player == 1 - self.AIPlayer:
                    if valid.valid(self.array, self.player, x, y):
                        screen.create_oval(68 + 50 * x, 68 + 50 * y, 32 + 50 * (x + 1), 32 + 50 * (y + 1),
                                           tags="highlight", fill="yellow", outline="yellow")
    ...
    def draw_score_board(self):
        ...
        screen.create_oval(490, 200, 510, 220, fill="white", outline="white")
        screen.create_oval(490, 260, 510, 280, fill="black", outline="black")
        ...
        screen.create_text(515, 210, anchor="w", tags="score", font=("Consolas", 30), fill="white", text=player_score)
        screen.create_text(565, 210, anchor="w", tags="score", font=("Consolas", 20), fill="white", text=str(single_time_white.seconds // 60) + ':' + str(single_time_white.seconds % 60) + '/')
        screen.create_text(655, 210, anchor="w", tags="score", font=("Consolas", 20), fill="white",text=str(total_time_white.seconds // 60) + ':' + str(total_time_white.seconds % 60))
       
        screen.create_text(515, 270, anchor="w", tags="score", font=("Consolas", 30), fill="black", text=computer_score)
        screen.create_text(565, 270, anchor="w", tags="score", font=("Consolas", 20), fill="black",
                           text=str(single_time_black.seconds // 60) + ':' + str(
                               single_time_black.seconds % 60) + '/')
        screen.create_text(655, 270, anchor="w", tags="score", font=("Consolas", 20), fill="black",
