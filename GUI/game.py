...
def draw_grid_background(outline=True):
    ...
    if outline:
        screen.create_rectangle(50, 50, 450, 450, fill="green", outline="black")
...
def init_game():
    ...
    running = False
    screen.delete(ALL)
    screen["background"]="#597E38"
    # Title and shadow
    screen.create_text(370, 203, anchor="c", text="Mini AlphaGo", font=("Consolas", 50), fill="#aaa")
    screen.create_text(370, 200, anchor="c", text="Mini AlphaGo", font=("Consolas", 50), fill="#fff")

    # choose player first or computer first
    screen.create_rectangle(150, 310, 330, 355, fill="#000", outline="#000")
    screen.create_rectangle(150, 300, 330, 350, fill="#111", outline="#111")
    screen.create_text(240, 326, anchor="c", text="Player First", font=("Consolas", 16),
                               fill="#b29600")
    screen.create_text(240, 327, anchor="c", text="Player First", font=("Consolas", 16),
                               fill="#b29600")

    screen.create_rectangle(410, 310, 575, 355, fill="#000", outline="#000")  
    screen.create_rectangle(410, 300, 575, 350, fill="#111", outline="#111")
    screen.create_text(495, 326, anchor="c", text="AI First", font=("Consolas", 16),
                       fill="#b29600")
    screen.create_text(495, 327, anchor="c", text="AI First", font=("Consolas", 16),
                       fill="#b29600")
